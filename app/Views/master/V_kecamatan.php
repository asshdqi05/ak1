                        ...
                        foreach ($data as $d) { ?>
                            <tr>
                                ...
                                <td class="text-center" width="100px">
                                    ...
                                    <a class="btn btn-sm btn-danger" href="javascript:void(0)" onclick="hapus('<?= $d->id ?>','<?= $d->nama_kecamatan ?>')">
...
<div class="modal fade" id="modal_add">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo site_url('C_kecamatan/save') ?>">
...
<div class="modal fade" id="edit_data">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo site_url('C_kecamatan/edit') ?>">
                <div class="modal-body">
                    <div class="modal-body">
...
<div class="modal fade" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo site_url('C_kecamatan/delete') ?>">
                <div class="modal-body">
